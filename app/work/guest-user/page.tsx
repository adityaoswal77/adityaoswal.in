  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <Link
          href="/work"
          className="inline-flex items-center gap-2 mb-16 text-[var(--muted)] hover:text-[var(--foreground)] transition-colors text-[14px]"
        >
        ...
        <div className="space-y-12">
          ...
          <h1
            ref={titleRef}
            className="text-[2.5rem] sm:text-6xl md:text-8xl lg:text-[9rem] font-bold leading-[0.85] tracking-normal text-[var(--foreground)]"
          >
            Guest Mode
            <br />
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pt-16 border-t border-[var(--border)]">
            <div>
              <dt className="text-[14px] font-bold text-[var(--muted)] mb-3">Role</dt>
              <dd className="text-xl font-bold text-[var(--foreground)]">Product Designer</dd>
            </div>
            <div>
              <dt className="text-[14px] font-bold text-[var(--muted)] mb-3">Timeline</dt>
              <dd className="text-xl font-bold text-[var(--foreground)]">3 Months</dd>
            </div>
            <div>
              <dt className="text-[14px] font-bold text-[var(--muted)] mb-3">Team</dt>
              <dd className="text-xl font-bold text-[var(--foreground)]">1 PM, 2 Devs</dd>
            </div>
            <div>
              <dt className="text-[14px] font-bold text-[var(--muted)] mb-3">Metric</dt>
      ...
      <div className="absolute -bottom-20 -right-20 pointer-events-none opacity-[0.02] select-none">
        <span className="text-[25rem] font-black leading-none tracking-tighter italic">
          Guest
        </span>
      </div>
    </section>
      ...
      <div className="max-w-6xl mx-auto">
        {title && (
          <h2
            ...
            ref={titleRef}
            className="text-5xl md:text-7xl font-black tracking-[0.01em] text-[var(--foreground)] mb-16 leading-[0.9]"
          >
            {title}
          </h2>
        )}
      ...
      <div className="flex flex-col gap-5">
        {STAGES.map((stage) => {
          ...
          return (
            ...
            >
              <span
                className={`text-[14px] leading-none motion-safe:transition-all motion-safe:duration-300 ${
                  isActive
        ...
        <div className="relative lg:grid lg:grid-cols-[200px_1fr]">
          ...
          <div className="min-w-0">
            ...
            <Section title="Context" id="context">
              <div className="space-y-12">
                <p className="text-lg font-medium leading-relaxed text-[var(--foreground)] opacity-80 max-w-4xl">
                  Kardia is a leading personal EKG device and app. This project focused on closing a specific gap: guest EKG recording.
                </p>
                <ul className="list-disc pl-5 space-y-4 marker:text-[var(--muted)]">
                  {[
                    ...
                    <li key={i} className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                      <span className="font-bold text-[var(--foreground)]">{item.title}.</span> {item.desc}
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <Section title="Process" id="process">
              <ul className="list-disc pl-5 space-y-4 marker:text-[var(--muted)]">
                {[
                  ...
                  <li key={item.num} className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                    <span className="font-bold text-[var(--foreground)]">{item.title}.</span> {item.desc}
                  </li>
                ))}
              </ul>
            ...
            <Section title="Narrowing" id="narrowing">
              <div className="space-y-16">
                <ul className="list-disc pl-5 space-y-4 marker:text-[var(--muted)]">
                  <li className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                    <span className="font-bold text-[var(--foreground)]">Before recording.</span> Asking users who is recording before it begins has faced resistance historically and doesn&apos;t serve the best experience.
                  </li>
                  <li className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                    <span className="font-bold text-[var(--foreground)]">During recording.</span> Not ideal — hands are engaged with the Kardia device during recording.
                  </li>
                  <li className="text-lg text-[var(--foreground)] font-medium leading-relaxed">
                    <span className="font-bold">Post recording <span className="font-normal opacity-60">(selected)</span>.</span> Ideal. Confirm who recorded the EKG after the fact.
                  </li>
                </ul>
                <ImageSection
            ...
            <Section title="Ideations & Testing" id="ideations">
              <div className="space-y-24">
                <ul className="list-disc pl-5 space-y-4 marker:text-[var(--muted)]">
                  <li className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                    <span className="font-bold text-[var(--foreground)]">Ideation 1.</span> Checkbox at the bottom of the result page before saving.
                  </li>
                  <li className="text-lg text-[var(--muted)] font-medium leading-relaxed">
                    <span className="font-bold text-[var(--foreground)]">Ideation 2.</span> Mid-page context box integrated with the clinical data.
                  </li>
                  <li className="text-lg text-[var(--foreground)] font-medium leading-relaxed">
                    <span className="font-bold">Ideation 3 <span className="text-[var(--muted)] font-normal">(winner)</span>.</span> Explicit assignment via a dropdown selector before the primary action.
                  </li>
                </ul>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                  <div className="space-y-0">
                    <div className="border-t border-[var(--border)] py-6">
                      <p className="text-[14px] font-bold text-[var(--foreground)] mb-6">Ideation 3 — Winning Flow</p>
                      <div className="grid grid-cols-2 gap-8">
                        <div>
                          <div className="text-4xl md:text-5xl font-black text-emerald-400">96.8%</div>
                          <div className="text-[12px] text-[var(--muted)] font-bold mt-2">Success Rate</div>
                        </div>
                        <div>
                          <div className="text-4xl md:text-5xl font-black text-[var(--foreground)]">3.2%</div>
                          <div className="text-[12px] text-[var(--muted)] font-bold mt-2">Drop-off</div>
                        </div>
                      </div>
                    </div>
                    <div className="border-t border-[var(--border)] py-6">
                      <p className="text-[14px] font-bold text-[var(--muted)] mb-6">Existing Flow</p>
                      <div className="grid grid-cols-2 gap-8">
                        <div>
              ...
              <div className="space-y-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    <h3 className="text-xl md:text-5xl font-black tracking-[0.01em] text-[var(--foreground)]">
                ...
                <div className="pt-16 border-t border-[var(--border)]">
                  <h3 className="text-[14px] font-bold mb-12 text-[var(--muted)] text-center">Before &amp; After</h3>
            ...
            <Section title="Results" id="results">
              <div className="space-y-12">
                <p className="text-[14px] font-bold text-[var(--muted)]">Guest recording over time (avg. figures, since Q3 2024)</p>
                <div className="space-y-0">
                  <div className="border-t border-[var(--border)] py-12 flex flex-col md:flex-row md:items-center gap-4 md:gap-12">
                    ...
                    <div className="text-[14px] font-bold text-[var(--muted)]">iOS Users</div>
                  </div>
                  <div className="border-t border-[var(--border)] py-12 flex flex-col md:flex-row md:items-center gap-4 md:gap-12">
                    <div className="text-5xl md:text-7xl font-black text-emerald-400">+3.8%</div>
                    <div className="text-[14px] font-bold text-[var(--muted)]">Android Users</div>
                  </div>
                </div>
              </div>
            </Section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col justify-center">
                  <blockquote className="border-l-2 border-[var(--border)] pl-6">
                    <p className="text-lg text-[var(--foreground)] font-medium leading-relaxed italic">
            ...
            <section className="px-6 py-40 bg-[var(--background)]">
              <div className="max-w-6xl mx-auto">
                <Link href="/work" className="group block text-center">
                  <p className="text-[14px] font-bold text-[var(--muted)] mb-8 block">End of Study</p>
                  <div className="flex flex-col items-center gap-12">
                    <h2 className="text-5xl md:text-9xl font-black tracking-tighter text-[var(--foreground)] group-hover:italic transition-all duration-500 group-hover:opacity-70">
                      Return to All
                    </h2>
