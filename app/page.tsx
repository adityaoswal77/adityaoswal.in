...
const SocialButton = ({ href, children, ariaLabel }: SocialButtonProps) => (
  <a
    className="flex items-center justify-center w-15 h-15 text-slate-100 hover:text-black font-medium tracking-tighter transition-all duration-300 hover:bg-green-400 border-2 border-slate-50 focus:border-green-400 focus:border-opacity-40 hover:border-green-400 focus:ring-4 focus:ring-green-400 focus:ring-opacity-40 rounded-full"
    href={href}
    target="_blank"
...
const ActionButton = ({ href, children }: ActionButtonProps) => (
  <a
    className="inline-block px-8 py-4 mx-2 text-slate-100 hover:text-black tracking-tighter transition-all duration-300 hover:bg-blue-500 border-2 border-slate-50 focus:border-green-400 focus:border-opacity-40 hover:border-blue-500 focus:ring-4 focus:ring-green-400 focus:ring-opacity-40 rounded-full"
    href={href}
    target="_blank"
    rel="noopener noreferrer"
  >
        ...
        <section className="w-full max-w-4xl mx-auto">
          <div className="text-center space-y-8">
            <div className="inline-flex items-center">
              <span className="inline-flex items-center rounded-md bg-green-200/20 px-2 py-1 text-sm font-medium text-green-600 ring-1 ring-inset ring-green-600/60">
                Personal Website
              </span>
            </div>
            
            <h1 className="text-5xl md:text-7xl lg:text-8xl text-slate-100 font-bold tracking-tighter">
              Aditya Oswal
            </h1>
            
            <p className="text-lg text-slate-100 max-w-sm mx-auto">
              Product Designer | Webflow Developer
            </p>
            
            <div className="flex font-medium flex-wrap justify-center gap-4">
              <ActionButton href="https://www.figma.com/proto/upYjzU2eQ4hDYXVhhvSqPn/Portfolio-Deck?page-id=0%3A1&type=design&node-id=415-443&viewport=-2824%2C-1072%2C0.19&t=ctFdwdz4IBYm11gK-1&scaling=contain&mode=design">
                Portfolio Link
              </ActionButton>
              <ActionButton href="https://drive.google.com/drive/folders/1d7JqAFL_SbR3dN9wo7B32x3Uzu-dpfzp?usp=sharing">
                Resume
              </ActionButton>
            </div>
