...
float pattern(vec2 p, float timeVal, float waveSpd, float waveFreq, float waveAmp) {
  vec2 p2 = p - timeVal * waveSpd;
...
const RetroEffect = forwardRef<RetroEffectImpl, any>((props, ref) => {
